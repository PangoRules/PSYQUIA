...
class Paciente(models.Model):
    ...
    sex = models.IntegerField(max_length=1,choices=sexo,default=1)
    name = models.CharField(max_length=60)
    study = models.IntegerField(max_length=1,choices=estudio,default=1)
    job = models.IntegerField(max_length=1,choices=ocupacion,default=1)
    civil_state = models.IntegerField(max_length=1,choices=civil,default=1)
    religion = models.IntegerField(max_length=1,choices=religionChoices,default=1)
    economical_situation  = models.IntegerField(max_length=1,choices=situacion,default=1)
